...
public class TypeRightLeaderboardFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.leaderboard_type_right_fragment, container, false);
	...
	public double[] getHighestScore(Player p){
		...
		ArrayList<Score> playerScores = dao.getPlayerScores(p,"TypeRight");
